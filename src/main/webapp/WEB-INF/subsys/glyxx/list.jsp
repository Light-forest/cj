    ...
    <div class="panel panel-info">
        ...
        <form  name="formlist" method="post" action="list"  >
           ...
           <div class="input-group input-group-sm"> 
               ...
               <input id="glyid" name="glyid" value="${glyxx.glyid}" placeholder="管理员编码" class="form-control"  aria-describedby="span_glyid"  /> 
           </div>        </div> 
       <div id='id_div_qry_glyzh' class="col-xs-3" style="display: block;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_glyzh">管理员账号</span> 
               <input id="glyzh" name="glyzh" value="${glyxx.glyzh}" placeholder="管理员账号" class="form-control"  aria-describedby="span_glyzh"  /> 
           </div>        </div> 
       <div id='id_div_qry_glymc' class="col-xs-3" style="display: block;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_glymc">管理员名称</span> 
               <input id="glymc" name="glymc" value="${glyxx.glymc}" placeholder="管理员名称" class="form-control"  aria-describedby="span_glymc"  /> 
           </div>        </div> 
       <div id='id_div_qry_glymm' class="col-xs-3" style="display: block;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_glymm">管理员密码</span> 
               <input id="glymm" name="glymm" value="${glyxx.glymm}" placeholder="管理员密码" class="form-control"  aria-describedby="span_glymm"  /> 
           </div>        </div> 
       <div id='id_div_qry_glyyx' class="col-xs-3" style="display: block;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_glyyx">管理员邮箱</span> 
               <input id="glyyx" name="glyyx" value="${glyxx.glyyx}" placeholder="管理员邮箱" class="form-control"  aria-describedby="span_glyyx"  /> 
           </div>        </div> 
       <div id='id_div_qry_glyzw' class="col-xs-3" style="display: block;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_glyzw">管理员职位</span> 
               <input id="glyzw" name="glyzw" value="${glyxx.glyzw}" placeholder="管理员职位" class="form-control"  aria-describedby="span_glyzw"  /> 
           </div>        </div> 
       <div id='id_div_qry_glyjs' class="col-xs-3" style="display: block;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_glyjs">管理员角色</span> 
               <input id="glyjs" name="glyjs" value="${glyxx.glyjs}" placeholder="管理员角色" class="form-control"  aria-describedby="span_glyjs"  /> 
           </div>        </div> 
       <div id='id_div_qry_glyms' class="col-xs-3" style="display: block;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_glyms">管理员描述</span> 
               <input id="glyms" name="glyms" value="${glyxx.glyms}" placeholder="管理员描述" class="form-control"  aria-describedby="span_glyms"  /> 
           </div>        </div> 
       <div id='id_div_qry_bz00' class="col-xs-3" style="display: none;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_bz00">备注项00</span> 
               <input id="bz00" name="bz00" value="${glyxx.bz00}" placeholder="备注项00" class="form-control"  aria-describedby="span_bz00"  /> 
           </div>        </div> 
       <div id='id_div_qry_bz01' class="col-xs-3" style="display: none;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_bz01">备注项01</span> 
               <input id="bz01" name="bz01" value="${glyxx.bz01}" placeholder="备注项01" class="form-control"  aria-describedby="span_bz01"  /> 
           </div>        </div> 
       <div id='id_div_qry_bz02' class="col-xs-3" style="display: none;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_bz02">备注项02</span> 
               <input id="bz02" name="bz02" value="${glyxx.bz02}" placeholder="备注项02" class="form-control"  aria-describedby="span_bz02"  /> 
           </div>        </div> 
       <div id='id_div_qry_bz03' class="col-xs-3" style="display: none;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_bz03">备注项03</span> 
               <input id="bz03" name="bz03" value="${glyxx.bz03}" placeholder="备注项03" class="form-control"  aria-describedby="span_bz03"  /> 
           </div>        </div> 
       <div id='id_div_qry_bz04' class="col-xs-3" style="display: none;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_bz04">备注项04</span> 
               <input id="bz04" name="bz04" value="${glyxx.bz04}" placeholder="备注项04" class="form-control"  aria-describedby="span_bz04"  /> 
           </div>        </div> 
       <div id='id_div_qry_bz05' class="col-xs-3" style="display: none;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_bz05">备注项05</span> 
               <input id="bz05" name="bz05" value="${glyxx.bz05}" placeholder="备注项05" class="form-control"  aria-describedby="span_bz05"  /> 
           </div>        </div> 
       <div id='id_div_qry_bz06' class="col-xs-3" style="display: none;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_bz06">备注项06</span> 
               <input id="bz06" name="bz06" value="${glyxx.bz06}" placeholder="备注项06" class="form-control"  aria-describedby="span_bz06"  /> 
           </div>        </div> 
       <div id='id_div_qry_bz07' class="col-xs-3" style="display: none;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_bz07">备注项07</span> 
               <input id="bz07" name="bz07" value="${glyxx.bz07}" placeholder="备注项07" class="form-control"  aria-describedby="span_bz07"  /> 
           </div>        </div> 
       <div id='id_div_qry_bz08' class="col-xs-3" style="display: none;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_bz08">备注项08</span> 
               <input id="bz08" name="bz08" value="${glyxx.bz08}" placeholder="备注项08" class="form-control"  aria-describedby="span_bz08"  /> 
           </div>        </div> 
       <div id='id_div_qry_bz09' class="col-xs-3" style="display: none;"> 
           <div class="input-group input-group-sm"> 
               <span class="input-group-addon" id="span_bz09">备注项09</span> 
               <input id="bz09" name="bz09" value="${glyxx.bz09}" placeholder="备注项09" class="form-control"  aria-describedby="span_bz09"  /> 
           </div>        </div> 
       ...
       <th style='display:none;'><a href="javascript:paixu('bz09');" id='a_bz09'>备注项09</a></th> 
        ...
        <td style='display:none;'>${c.bz09}</td>  
                        ...
                        <td style="text-align: center;">
                            ...
                            <a class='btn btn-warning btn-xs btn-detail' onClick="return confirm('确定删除?');"   href="remove/${c.glyid}">删除</a>
