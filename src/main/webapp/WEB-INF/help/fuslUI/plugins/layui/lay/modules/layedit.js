...
layui.define(['layer', 'form'], function(exports){
  ...
  ,tools = {
    ...
    ,strong: '<i class="fa fa-bold" title="加粗" lay-command="Bold" layedit-event="b""></i>'
    ,italic: '<i class="fa fa-italic" title="斜体" lay-command="italic" layedit-event="i""></i>'
    ,underline: '<i class="fa fa-underline" title="下划线" lay-command="underline" layedit-event="u""></i>'
    ,del: '<i class="fa fa-strikethrough" title="删除线" lay-command="strikeThrough" layedit-event="d""></i>'
    
    ,'|': '<span class="layedit-tool-mid"></span>'
    
    ,left: '<i class="fa fa-align-left" title="左对齐" lay-command="justifyLeft" layedit-event="left""></i>'
    ,center: '<i class="fa fa-align-center" title="居中对齐" lay-command="justifyCenter" layedit-event="center""></i>'
    ,right: '<i class="fa fa-align-right" title="右对齐" lay-command="justifyRight" layedit-event="right""></i>'
    //,link: '<i class="fa fa-link" title="插入链接" layedit-event="link""></i>'
    //,unlink: '<i class="fa fa-unlink layui-disabled" title="清除链接" lay-command="unlink" layedit-event="unlink""></i>'
    //,face: '<i class="fa fa-smile-o" title="表情" layedit-event="face""></i>'
    ,image: '<i class="fa fa-file-image-o layedit-tool-image" title="图片" layedit-event="image"><input type="file" name="file"></i>'
    ,code: '<i class="fa fa-code" title="插入代码" layedit-event="code"></i>'
    
    ,help: '<i class="fa fa-question-circle-o" title="帮助" layedit-event="help"></i>'
  }
