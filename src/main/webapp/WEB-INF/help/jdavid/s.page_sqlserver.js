		...
		*/
        ...
        function get_s_html_down_mark_of_fenye(s_record_count,s_size_per_page){
		 //  1 2 3 4 5 6 7 8 9 .....22
		   ...
		   s_html+="<td>";
		   s_html+="共"+s_count+"条";
		   s_html+="共<span id='id_span_page_cur'>1</span>/"+i_max+"页";
           s_html+="</td>";
		   s_html+="<td>";
		   ...
		   s_html+="<a href=\"javascript:goto_page('"+i_max+"')\">末页</a>";
		   s_html+="</td>";
		   
		   s_html+="<td>";
		   s_html+="第<input name='name_input_pageno_input' type='text' "
		         +"style='font-size:12px;width:40px;height:12px;border:1px #cccccc solid;' id='id_input_pageno_input' />";
		   s_html+="<a href=\"javascript:goto_page_input()\">GO!</a>页";
		   s_html+="</td>";
