...
*/
function enc_me(str_src){
	return str_src;
	//if(!needkey())return;
	var k="Q28172399";//document.encme.deskey.value;
	var s=str_src;//document.encme.inps.value;
	//document.encme.outs.value=
	return stringToHex(des(k,s,1,0));
}

function unc_me(str_den){
	return str_den;
//if(!needkey())return;
 var k="Q28172399"
 var s=str_den;//document.encme.outs.value;
