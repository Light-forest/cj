		...
		*/
        ...
        function get_sql_fenye_query_inner_sqlserver___(
					s_tableName,
					s_primayKey, 
					s_where_not_with_where, 
					s_orderBy,
        ...
        function get_sql_fenye_query_inner_sqlserver(//oracle
					s_tableName,
					s_primayKey, 
					s_where_not_with_where, 
					s_orderBy,
					...
					)
        {
            ...
            var sql ="";
			sql+="    SELECT * "; 
			sql+="    FROM (SELECT TT.*, ROWNUM AS ROWNO  "; 
			sql+="             FROM (Select T.*  "; 
			sql+="                      from "+s_tableName+" T  "; 
			sql+="                     where "+s_where_not_with_where+" "; 
			sql+="                     ORDER BY "+s_orderBy+" "+a_s_desc+") TT  "; 
			sql+="            WHERE ROWNUM ＜= "+num_cur+") TABLE_ALIAS  "; 
			sql+="    where TABLE_ALIAS.rowno ＞ "+num_perior+"  "; 
